...
def v_riadku(idx, slovo, osems):
    ...
    - pridava do glob. premennej suradnice , z ktorej sa neskor "skrtaju" pismenka
    - tak isto pridava do glob. premennej vyskrtnute_slova, ktore potom vyhodim zo slov, kt. este musime najst
    """
...
osems, vtip = ziskaj_zadanie("osemsmerovka 21x21.txt") # ("osemsmerovka 12x12.txt") # ("osemsmerovka 21x21.txt") # ("osemsmerovka 25x20 2021.txt")# #  # # 
